      ...
      <section className="w-full py-16 lg:py-24 bg-surface">
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-6">
            <div>
              <span className="text-primary font-bold uppercase tracking-widest text-xs sm:text-sm">Eksplorasi Katalog</span>
              <h2 className="font-h2 text-3xl sm:text-4xl text-on-surface font-bold mt-2 tracking-tight text-balance">Koleksi Spesies Terpilih</h2>
            </div>
            <Link to="/map" className="text-primary font-bold flex items-center gap-2 group text-base shrink-0 hover:text-primary-container transition-colors">
              Lihat Semua Katalog 
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <Link to="/map?category=ornamental" className="md:col-span-8 group relative overflow-hidden rounded-2xl shadow-sm border border-outline-variant/30 h-[300px] sm:h-[400px] lg:h-[480px] block w-full">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-6 sm:p-8 lg:p-10">
                ...
                <h3 className="text-2xl sm:text-3xl font-h3 text-white font-bold tracking-tight mb-2">Tanaman Hias & Eksotis</h3>
            ...
            <Link to="/map?category=food" className="md:col-span-4 group relative overflow-hidden rounded-2xl shadow-sm border border-outline-variant/30 h-[300px] sm:h-[400px] lg:h-[480px] block w-full">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-6 sm:p-8 text-white">
                <h3 className="text-2xl sm:text-3xl font-h3 font-bold tracking-tight mb-2">Sumber Pangan</h3>
            ...
            <Link to="/map?category=herbal" className="md:col-span-6 group relative overflow-hidden rounded-2xl shadow-sm border border-outline-variant/30 h-[300px] sm:h-[350px] lg:h-[400px] block w-full">
              <img 
                alt="Tanaman Obat" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-6 sm:p-8 text-white">
                <h3 className="text-2xl sm:text-3xl font-h3 font-bold tracking-tight mb-2">Tanaman Obat & Herbal</h3>
                <p className="text-white/80 text-sm sm:text-base line-clamp-3">Database etnobotani dan khasiat tanaman herbal nusantara.</p>
              </div>
            </Link>

            <Link to="/map" className="md:col-span-6 group relative overflow-hidden rounded-2xl shadow-sm border border-outline-variant/30 h-[300px] sm:h-[350px] lg:h-[400px] bg-primary block w-full">
              ...
              <div className="relative z-10 h-full flex flex-col justify-center items-center text-center p-6 sm:p-8 text-on-primary">
                <span className="material-symbols-outlined text-5xl sm:text-6xl lg:text-[72px] mb-4 drop-shadow-md">layers</span>
                <h3 className="text-2xl sm:text-3xl font-h3 font-bold tracking-tight mb-3">Lapisan Data Geospasial</h3>
                <p className="text-on-primary/90 mb-6 text-sm sm:text-base max-w-md text-balance">Akses ribuan dataset spasial untuk analisis lingkungan tingkat lanjut.</p>
